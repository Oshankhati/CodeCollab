...
//     // 🔹 Send Welcome Email (same as yours)
...
//     from: `"CodeCollab Team" <${process.env.EMAIL_USER}>`,
//     to: user.email,
...
//     // ✅ IMPORTANT: return same as login
//     res.json({
//       token,
//       user: {
//         id: user._id,
...
//     // 🔹 Email content
//     const mailOptions = {
//       from: `"CodeCollab Support" <${process.env.EMAIL_USER}>`,
//       to: user.email,
